    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "An error try of entering.");
                    return View(model);
            }
        }
        ...
        /// <summary>
        /// Dispose pattern - free the memory resources
        /// </summary>
        /// <param name="disposing">Verification parametr if we need to dispose</param>
